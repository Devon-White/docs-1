...
1. Weaviate cluster
    ...
    2. [Embedded Weaviate](/docs/weaviate/installation/embedded)
    3. [Local deployment](/docs/weaviate/installation-guides/docker-installation#starter-docker-compose-file)
    4. [Other options](/docs/weaviate/installation)
...
Full list of [generative models](/docs/weaviate/model-providers/octoai/generative#available-models)
